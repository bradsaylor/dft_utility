...
int write_output_file(char* output_filename, const char* output_dir,
  ...
  switch (output_mode) {
    case (OUTPUT_CSV):
      if (write_CSV(output_filename, output_dir, output_sequence,
                    output_length)) {
      ...
      break;
    case (OUTPUT_TXT):
      if (write_TXT(output_filename, output_dir, output_sequence,
                    output_length)) {
      ...
      break;
    case (OUTPUT_BIN):
      if (write_BIN(output_filename, output_dir, output_sequence,
                    output_length)) {
